...
function printHelp () {
  ...
  echo "    -c <channel name> - channel name to use (defaults to \"CommonChannel)"
  ...
  echo
  echo "	insurance-network.sh generate -c commonchannel"
  echo "	insurance-network.sh up -l node"
  echo "	insurance-network.sh down -c commonchannel"
  echo
