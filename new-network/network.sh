...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/hospitalAhospitalA/msp organizations/fabric-ca/hospitalAhospitalA/tls-cert.pem organizations/fabric-ca/hospitalAhospitalA/ca-cert.pem organizations/fabric-ca/hospitalAhospitalA/IssuerPublicKey organizations/fabric-ca/hospitalAhospitalA/IssuerRevocationPublicKey organizations/fabric-ca/hospitalAhospitalA/fabric-ca-server.db'
