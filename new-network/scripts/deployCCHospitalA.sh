...
checkCommitReadiness "hospitalA" "\"HospitalAMSP\": true" "\"HospitalBMSP\": false"

## check whether the chaincode definition is ready to be committed
## expect them both to have approved
checkCommitReadiness "hospitalA" "\"HospitalAMSP\": true" "\"HospitalBMSP\": true"

## now that we know for sure both orgs have approved, commit the definition
commitChaincodeDefinition "hospitalA" "hospitalB"
